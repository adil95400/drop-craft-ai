-- Create tables for Phase 1: Hub Fournisseurs & Import Multi-formats
...
CREATE INDEX IF NOT EXISTS idx_sync_schedules_next_sync ON public.sync_schedules(next_sync_at) WHERE enabled = true;
