...
-- Ajouter les triggers de logging manquants
...
BEGIN
  ...
  config_status := jsonb_build_object(
    ...
    'triggers_configured', 'Logging triggers added for sensitive data access',
