...
-- Modifier la table profiles pour utiliser le nouveau type
ALTER TABLE public.profiles 
  ALTER COLUMN plan TYPE plan_type USING 
    CASE 
      WHEN plan = 'free' THEN 'standard'::plan_type
      WHEN plan = 'ultra_pro' THEN 'ultra_pro'::plan_type
      ELSE 'standard'::plan_type
    END;
    
ALTER TABLE public.profiles ALTER COLUMN plan SET DEFAULT 'standard'::plan_type;
