...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { user_id, integration_id, platform, direction = 'import', customer_ids } = await req.json() as CustomerSyncRequest
    ...
    console.log(`👥 Customer sync starting for user ${user_id}, direction: ${direction}`)
