...
export function useApiSync() {
  ...
  return {
    ...
    syncHistory,
    schedules: [],
    createSchedule: { mutate: (_params: unknown) => { /* Schedule creation not yet implemented */ }, isPending: false },
    deleteSchedule: { mutate: (_id: unknown) => { /* Schedule deletion not yet implemented */ }, isPending: false },
