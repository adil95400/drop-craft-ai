                  ...
                  {queuedUrls.map((item, index) => (
                    <motion.div 
                      ...
                      className={cn(
                        ...
                        item.status === 'success' && "bg-success/5 border-green-500/20 hover:border-green-500/40",
                        ...
                        {item.preview ? (
                          <>
                            ...
                            <div className="flex flex-wrap items-center gap-2 text-sm">
                              ...
                              <div className="flex items-center gap-1.5 bg-success/10 px-2 py-0.5 rounded-md border border-green-500/20">
