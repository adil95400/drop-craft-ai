...
export default function AliExpressImportPage() {
  ...
  const handleImport = async () => {
    if (!url) {
      toast.error('Veuillez entrer une URL AliExpress');
      return;
    }
    setIsImporting(true);
    setProgress(0);
    ...
    const interval = setInterval(() => {
      setProgress(prev => {
        if (prev >= 100) {
          ...
          toast.success('Produit AliExpress importé avec succès !');
          return 100;
        }
        return prev + 5;
      });
      ...
      <div className="bg-gradient-to-r from-[#E43A3F] to-[#FF6A00] text-white">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-4">
            <img src="/logos/aliexpress-logo.svg" alt="AliExpress" className="w-16 h-16 bg-white rounded-xl p-2" />
            <div>
          ...
          <div className="flex gap-4 mt-6">
            <Badge className="bg-white/20 text-white border-0">
              <Package className="w-3 h-3 mr-1" /> 500M+ Produits
            </Badge>
            <Badge className="bg-white/20 text-white border-0">
              <Video className="w-3 h-3 mr-1" /> Vidéos incluses
            </Badge>
            <Badge className="bg-white/20 text-white border-0">
              <Truck className="w-3 h-3 mr-1" /> Livraison mondiale
            </Badge>
          </div>
        </div>
      </div>
        ...
        <Tabs defaultValue="url" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Link className="w-5 h-5 text-[#E43A3F]" />
                  Import par URL AliExpress
                </CardTitle>
                <CardDescription>
                  Importez un produit avec toutes ses données, images, vidéos et avis
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <Button 
                    ...
                    className="bg-[#E43A3F] hover:bg-[#c92f33]"
                  >
                    {isImporting ? (
                ...
                {isImporting && (
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground">
                      <span>Extraction complète... {progress}%</span>
                      <span>
                        {progress < 30 && 'Récupération des données...'}
                        {progress >= 30 && progress < 60 && 'Téléchargement des images...'}
                        {progress >= 60 && progress < 90 && 'Import des vidéos...'}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-2">
                      <Video className="w-4 h-4 text-[#E43A3F]" />
                      <span className="text-sm">Importer les vidéos</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">Importer les avis</span>
                    </div>
          ...
          <TabsContent value="search" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Search className="w-5 h-5 text-[#E43A3F]" />
                  Recherche AliExpress
                </CardTitle>
                <CardDescription>
                  Trouvez des produits gagnants directement depuis AliExpress
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button className="bg-[#E43A3F] hover:bg-[#c92f33]">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Badge variant="outline" className="cursor-pointer hover:bg-accent">Mode Femme</Badge>
                  <Badge variant="outline" className="cursor-pointer hover:bg-accent">Mode Homme</Badge>
                  ...
                  <Badge variant="outline" className="cursor-pointer hover:bg-accent">Auto</Badge>
                </div>
          ...
          <TabsContent value="trending" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <TrendingUp className="w-5 h-5 text-[#E43A3F]" />
                  Produits Tendances
                </CardTitle>
                <CardDescription>
                  Les produits les plus populaires sur AliExpress cette semaine
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {trendingProducts.map((product) => (
                    <div key={product.id} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-accent/50 transition-colors">
                      ...
                      <Button size="sm" className="bg-[#E43A3F] hover:bg-[#c92f33]">
          ...
          <TabsContent value="suppliers" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Truck className="w-5 h-5 text-[#E43A3F]" />
                  Fournisseurs Vérifiés
                </CardTitle>
                <CardDescription>
                  Trouvez des fournisseurs fiables avec des produits de qualité
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12 text-muted-foreground">
                  <Truck className="w-12 h-12 mx-auto mb-4 opacity-50" />
                  <p className="mb-4">Fonctionnalité bientôt disponible</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#E43A3F]/10 rounded-lg">
                  <Package className="w-5 h-5 text-[#E43A3F]" />
                </div>
                <div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Vidéos incluses</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">vs retail</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Import complet</p>
                </div>
              </div>
            </CardContent>
          </Card>
