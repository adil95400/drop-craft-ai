        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-white rounded-xl p-2 flex items-center justify-center">
              <Warehouse className="w-8 h-8 text-[#1890FF]" />
            </div>
            <div>
          ...
          <div className="flex gap-4 mt-6">
            <Badge className="bg-white/20 text-white border-0"><Warehouse className="w-3 h-3 mr-1" /> Entrepôts EU/US</Badge>
            <Badge className="bg-white/20 text-white border-0"><Package className="w-3 h-3 mr-1" /> 400K+ Produits</Badge>
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <Card key={adv.title}>
              <CardContent className="pt-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#1890FF]/10 rounded-lg"><adv.icon className="w-5 h-5 text-[#1890FF]" /></div>
        ...
        <Tabs defaultValue="url" className="space-y-6">
          ...
          <TabsContent value="url" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Link className="w-5 h-5 text-[#1890FF]" />Import par URL</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <Button onClick={() => handleImport(url)} disabled={isImporting} className="bg-[#1890FF] hover:bg-[#096DD9]">
          ...
          <TabsContent value="sku" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Package className="w-5 h-5 text-[#1890FF]" />Import par SKU CJ</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <Button onClick={() => handleImport(`https://cjdropshipping.com/product-p-${sku}.html`)} disabled={isImporting} className="bg-[#1890FF] hover:bg-[#096DD9]">
          ...
          <TabsContent value="search" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Search className="w-5 h-5 text-[#1890FF]" />Recherche CJ</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <Button className="bg-[#1890FF] hover:bg-[#096DD9]"><Search className="w-4 h-4 mr-2" />Rechercher</Button>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
          {[
            { label: 'Produits', value: '400K+', icon: Package, color: 'text-[#1890FF]', bg: 'bg-[#1890FF]/10' },
