...
const TYPE_CONFIG = {
  feature: { icon: Sparkles, label: 'Nouveauté', color: 'bg-success/10 text-success border-success/20' },
  improvement: { icon: Zap, label: 'Amélioration', color: 'bg-info/10 text-info border-info/20' },
