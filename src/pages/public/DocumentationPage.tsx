  ...
  const categories = [
    {
      ...
      articles: [
        ...
        { title: "Gestion des variantes et options", link: "/documentation/gestion-des-variantes-et-options" },
        { title: "Édition groupée (Bulk Edit)", link: "/documentation/edition-groupee-bulk-edit" },
        { title: "Catégories et collections", link: "/documentation/categories-et-collections" },
        { title: "Gestion du stock", link: "/documentation/gestion-du-stock" },
      ]
    },
    {
      ...
      articles: [
        ...
        { title: "Gestion multi-fournisseurs", link: "/documentation/gestion-multi-fournisseurs" },
        { title: "Import CJ Dropshipping", link: "/documentation/import-cj-dropshipping" },
        { title: "Import BigBuy", link: "/documentation/import-bigbuy" },
        { title: "Résoudre les conflits de stock", link: "/documentation/resoudre-les-conflits-de-stock" },
      ]
    },
    {
      title: "Boutiques & Canaux", icon: Globe, color: "bg-purple-500/10 text-purple-600",
      articles: [
        { title: "Connexion Shopify", link: "/documentation/connexion-shopify" },
        { title: "Connexion WooCommerce", link: "/documentation/connexion-woocommerce" },
        { title: "Publication sur Amazon", link: "/documentation/publication-sur-amazon" },
        { title: "Publication sur eBay", link: "/documentation/publication-sur-ebay" },
        { title: "Multi-canal avancé", link: "/documentation/multi-canal-avance" },
        { title: "Feeds produits XML/CSV", link: "/documentation/feeds-produits-xml-csv" },
      ]
    },
    {
      ...
      articles: [
        ...
        { title: "Gestion des retours", link: "/documentation/gestion-des-retours" },
        { title: "Commandes groupées", link: "/documentation/commandes-groupees" },
        { title: "Impression d'étiquettes", link: "/documentation/impression-d-etiquettes" },
        { title: "Notifications clients", link: "/documentation/notifications-clients" },
      ]
    },
    {
      ...
      articles: [
        ...
        { title: "Coupons et promotions", link: "/documentation/coupons-et-promotions" },
        { title: "CRM et segmentation", link: "/documentation/crm-et-segmentation" },
        { title: "A/B Testing", link: "/documentation/a-b-testing" },
        { title: "SEO et contenu", link: "/documentation/seo-et-contenu" },
      ]
    },
    {
      title: "Analytics & IA", icon: Bot, color: "bg-cyan-500/10 text-cyan-600",
      articles: [
        { title: "Dashboard analytics", link: "/documentation/dashboard-analytics" },
        { title: "Prévisions de ventes IA", link: "/documentation/previsions-de-ventes-ia" },
        { title: "Recommandations IA", link: "/documentation/recommandations-ia" },
        { title: "Repricing dynamique", link: "/documentation/repricing-dynamique" },
        { title: "Rapports personnalisés", link: "/documentation/rapports-personnalises" },
        { title: "Alertes intelligentes", link: "/documentation/alertes-intelligentes" },
      ]
    },
    {
      title: "Automatisation", icon: RefreshCw, color: "bg-indigo-500/10 text-indigo-600",
      articles: [
        { title: "Workflows automatisés", link: "/documentation/workflows-automatises" },
        { title: "Règles de traitement", link: "/documentation/regles-de-traitement" },
        { title: "Auto-fulfillment", link: "/documentation/auto-fulfillment" },
        { title: "Triggers et actions", link: "/documentation/triggers-et-actions" },
        { title: "Planification de tâches", link: "/documentation/planification-de-taches" },
    ...
    },
    {
      ...
      articles: [
        ...
        { title: "Factures et paiements", link: "/documentation/factures-et-paiements" },
        { title: "Crédits IA", link: "/documentation/credits-ia" },
        { title: "Essai gratuit", link: "/documentation/essai-gratuit" },
        { title: "Programme entreprise", link: "/documentation/programme-entreprise" },
      ]
    },
    {
      title: "Intégrations", icon: PlugZap, color: "bg-pink-500/10 text-pink-600",
      articles: [
        { title: "API REST complète", link: "/documentation/api-rest-complete" },
        { title: "Extensions Chrome", link: "/documentation/extensions-chrome" },
        { title: "Zapier & Make", link: "/documentation/zapier-make" },
        { title: "Google Analytics", link: "/documentation/google-analytics" },
        { title: "Facebook Pixel", link: "/documentation/facebook-pixel" },
        { title: "Webhooks sortants", link: "/documentation/webhooks-sortants" },
      ]
    },
  ];
