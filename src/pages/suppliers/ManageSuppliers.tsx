    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Gérez vos {stats.total} fournisseurs et leurs catalogues
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <Button onClick={() => navigate('/suppliers/manage/connectors')}>
      ...
      <Tabs defaultValue="list" className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="analyze">Analyser un site</TabsTrigger>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Analyser un site fournisseur
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Entrez l'URL d'un site fournisseur pour l'analyser automatiquement avec l'IA
              </p>
              <div className="flex gap-3">
                <Input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm">Total pays</span>
                  <span className="font-bold">{Object.keys(stats.topCountries).length}</span>
                </div>
              </CardContent>
            </Card>
          </div>
