/**
 * Feed Optimization Page
 * Page d'optimisation IA des feeds - Style Channable avancé
 */
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Améliorez vos flux produits avec l'intelligence artificielle
          </p>
        </div>
        <div className="flex gap-2">
          <Button 
            ...
            disabled={analyzeProducts.isPending || products.length === 0}
          >
          ...
          <Button 
            ...
            disabled={optimizeProducts.isPending || products.length === 0}
          >
            {optimizeProducts.isPending ? (
              <Loader2 className="h-4 w-4 mr-2 animate-spin" />
            ) : (
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-red-500">{stats.highIssues}</p>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-yellow-500">{stats.mediumIssues}</p>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            {rec.affectedProducts > 0 && (
                              <p className="text-xs text-muted-foreground mt-1">
                                {rec.affectedProducts} produit(s) concerné(s)
                              </p>
                            )}
                          </div>
                        </div>
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  {products.length === 0 
                    ? "Ajoutez des produits pour obtenir des recommandations IA"
                    : "Vos produits semblent bien optimisés !"}
                </p>
              </CardContent>
            </Card>
          )}
          ...
          {analysisResults.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Cliquez sur "Analyser" pour scanner vos produits
                </p>
          ...
          {optimizationResults.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Cliquez sur "Optimiser avec IA" pour générer des améliorations
                </p>
                    ...
                    <Card key={result.productId} className="border-primary/20">
                      ...
                      <CardContent className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                              ...
                              <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg">
                                <p className="text-xs text-primary mb-1">Après (IA)</p>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                              <div className="p-3 bg-muted/50 rounded-lg max-h-32 overflow-y-auto">
                                <p className="text-xs text-muted-foreground mb-1">Avant</p>
                                <p className="text-sm">{result.originalDescription || 'Aucune description'}</p>
                              </div>
                              <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg max-h-32 overflow-y-auto">
                                <p className="text-xs text-primary mb-1">Après (IA)</p>
                                <p className="text-sm">{result.optimizedDescription}</p>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {result.suggestions && result.suggestions.length > 0 && (
                          <div className="space-y-2">
                            <p className="text-sm font-medium">Suggestions supplémentaires</p>
