...
interface WhyShopOptiSectionProps {
  socialProof?: typeof SOCIAL_PROOF;
}

export const WhyShopOptiSection = memo(({ socialProof = SOCIAL_PROOF }: WhyShopOptiSectionProps) => {
  const TRUST_ITEMS = [
    ...
    { icon: Layers, title: `${socialProof.supplierCount} Integrations`, desc: "AliExpress, Amazon, CJ, Spocket, BigBuy, and 94 more suppliers connected." },
