...
import { SOCIAL_PROOF, TESTIMONIALS, type Testimonial } from "@/config/landingPageConfig";
...
export const ProofSection = memo(({ socialProof = SOCIAL_PROOF, testimonials = TESTIMONIALS }: ProofSectionProps) => (
  <section className="py-16 lg:py-24" aria-label="Customer testimonials">
    <div className="container mx-auto px-4 sm:px-6">
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-lg text-muted-foreground">Join {socialProof.merchantCount} sellers who scaled their stores with AI automation.</p>
      </div>
