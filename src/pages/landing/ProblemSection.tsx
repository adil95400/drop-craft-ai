...
export const ProblemSection = memo(() => (
  <section className="py-14 sm:py-16 lg:py-24" aria-labelledby="problem-heading">
    <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
      <div className="text-center space-y-3 sm:space-y-4 mb-10 sm:mb-14">
        ...
        >
          Running a Shopify store shouldn't feel like a full-time job
        </h2>
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto" style={{ textWrap: 'pretty' }}>
