...
const CATEGORY_MAP = {
  transactional: { label: 'Transactionnel', color: 'text-info bg-info/5 dark:bg-info/10 dark:text-blue-400' },
  marketing: { label: 'Marketing', color: 'text-pink-600 bg-pink-50 dark:bg-pink-500/10 dark:text-pink-400' },
  retention: { label: 'Rétention', color: 'text-warning bg-amber-50 dark:bg-warning/10 dark:text-amber-400' },
};
