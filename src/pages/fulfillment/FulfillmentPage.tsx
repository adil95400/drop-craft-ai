...
export default function FulfillmentPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Fulfillment & Logistique - ShopOpti</title>
        <meta name="description" content="Gérez vos expéditions, transporteurs et retours. Automatisez vos commandes fournisseurs avec suivi en temps réel." />
      </Helmet>
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">📦 Fulfillment & Logistique</h1>
            <p className="text-muted-foreground">
              Gestion automatisée des commandes, expéditions et retours
            </p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" size="sm" asChild>
              <Link to="/fulfillment/carriers">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 h-auto">
            <TabsTrigger value="auto" className="text-xs md:text-sm py-2">
