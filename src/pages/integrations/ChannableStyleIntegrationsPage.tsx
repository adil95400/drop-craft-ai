/**
 * Page d'Intégrations style Channable - 100% Fonctionnelle
...
interface IntegrationDefinition {
  ...
  name: string
  logo: string
  category: 'marketplaces' | 'search_ppc' | 'social' | 'comparison' | 'affiliates' | 'data_import' | 'ecommerce' | 'other'
  popular?: boolean
  description?: string
  features?: string[]
  setupFields?: {
...
const integrationDefinitions: IntegrationDefinition[] = [
  ...
  { id: 'fnac', name: 'Fnac', logo: 'https://www.fnac.com/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  { id: 'rakuten', name: 'Rakuten', logo: 'https://www.rakuten.fr/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  { 
    id: 'aliexpress', 
    name: 'AliExpress', 
  ...
  { id: 'etsy', name: 'Etsy', logo: 'https://www.etsy.com/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'api_key', label: 'API Key', type: 'password', required: true }] },
  { id: 'zalando', name: 'Zalando', logo: 'https://www.zalando.fr/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'client_id', label: 'Client ID', type: 'text', required: true }] },
  { id: 'manomano', name: 'ManoMano', logo: 'https://www.manomano.fr/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  { id: 'backmarket', name: 'Back Market', logo: 'https://www.backmarket.fr/favicon.ico', category: 'marketplaces', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  ...
  { id: 'microsoft_ads', name: 'Microsoft Ads', logo: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg', category: 'search_ppc', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  { id: 'amazon_ads', name: 'Amazon Ads', logo: 'https://advertising.amazon.com/favicon.ico', category: 'search_ppc', setupFields: [{ name: 'access_token', label: 'Access Token', type: 'password', required: true }] },
  { id: 'criteo', name: 'Criteo', logo: 'https://www.criteo.com/favicon.ico', category: 'search_ppc', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  ...
  { id: 'pinterest', name: 'Pinterest', logo: 'https://www.pinterest.com/favicon.ico', category: 'social', setupFields: [{ name: 'access_token', label: 'Access Token', type: 'password', required: true }] },
  { id: 'snapchat', name: 'Snapchat', logo: 'https://www.snapchat.com/favicon.ico', category: 'social', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  ...
  { id: 'idealo', name: 'Idealo', logo: 'https://www.idealo.fr/favicon.ico', category: 'comparison', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  { id: 'kelkoo', name: 'Kelkoo', logo: 'https://www.kelkoo.fr/favicon.ico', category: 'comparison', setupFields: [{ name: 'merchant_id', label: 'Merchant ID', type: 'text', required: true }] },
  { id: 'leguide', name: 'LeGuide', logo: 'https://www.leguide.com/favicon.ico', category: 'comparison', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
  
  // Affiliés
  { id: 'awin', name: 'Awin', logo: 'https://www.awin.com/favicon.ico', category: 'affiliates', setupFields: [{ name: 'api_token', label: 'API Token', type: 'password', required: true }] },
  { id: 'tradedoubler', name: 'Tradedoubler', logo: 'https://www.tradedoubler.com/favicon.ico', category: 'affiliates', setupFields: [{ name: 'api_key', label: 'Clé API', type: 'password', required: true }] },
...
// Composant Carte d'intégration améliorée
...
export default function ChannableStyleIntegrationsPage() {
  const { integrations, connectedIntegrations, stats, isLoading } = useIntegrationsUnified()
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted/30 py-12 lg:py-20">
        ...
        <section className="container mx-auto px-4 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-1">
              {filteredIntegrations.length} intégrations disponibles
            </p>
          </div>
