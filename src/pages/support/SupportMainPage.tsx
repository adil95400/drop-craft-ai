...
export default function SupportMainPage() {
  ...
  const getStatusConfig = (status: string) => {
    const configs = {
      open: { icon: AlertCircle, color: 'text-destructive', bg: 'bg-destructive/10', label: 'Ouvert' },
      pending: { icon: Clock, color: 'text-warning', bg: 'bg-warning/10', label: 'En attente' },
      resolved: { icon: CheckCircle, color: 'text-success', bg: 'bg-success/10', label: 'Résolu' }
    };
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-4 pt-2 border-t">
                                ...
                                <div className="flex gap-2">
                                  <Button variant="outline" size="sm" className="h-8 gap-1.5 hover:bg-success/10 hover:text-success hover:border-emerald-500/30">
