...
export function ExtensionConnectionHub() {
  ...
  const getPlatformColor = (platform: string) => {
    const colors: Record<string, string> = {
      aliexpress: 'bg-orange-500/10 text-warning border-orange-500/30',
      amazon: 'bg-yellow-500/10 text-warning border-yellow-500/30',
      ebay: 'bg-blue-500/10 text-info border-blue-500/30',
      temu: 'bg-pink-500/10 text-pink-600 border-pink-500/30',
      shopify: 'bg-green-500/10 text-success border-green-500/30',
              ...
              <div>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {connectionStatus?.connected ? (
                    ...
                    <Badge variant="outline" className="bg-amber-500/10 text-warning border-amber-500/30">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        >
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-blue-500/10 text-info">
        ...
        >
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-green-500/10 text-success">
