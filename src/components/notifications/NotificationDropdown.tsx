...
const TYPE_COLORS: Record<string, string> = {
  success: "bg-emerald-100 text-success dark:bg-emerald-500/20 dark:text-emerald-400",
  error: "bg-red-100 text-destructive dark:bg-red-500/20 dark:text-red-400",
  warning: "bg-amber-100 text-warning dark:bg-amber-500/20 dark:text-amber-400",
  info: "bg-blue-100 text-info dark:bg-blue-500/20 dark:text-blue-400",
};
