...
const statusConfig = {
  connected: { icon: CheckCircle2, color: 'text-success', bg: 'bg-green-500/10', label: 'Connecté' },
  disconnected: { icon: AlertCircle, color: 'text-muted-foreground', bg: 'bg-muted', label: 'Déconnecté' },
  pending: { icon: Clock, color: 'text-warning', bg: 'bg-yellow-500/10', label: 'En attente' },
  error: { icon: AlertCircle, color: 'text-destructive', bg: 'bg-destructive/10', label: 'Erreur' },
  active: { icon: Zap, color: 'text-success', bg: 'bg-green-500/10', label: 'Actif' },
