...
export const ImportHub = ({ onViewChange, onCategorySelect }: ImportHubProps) => {
  ...
  const categories = [
    ...
    { id: 'files', title: 'Fichiers & Feeds', description: 'CSV, XML, JSON, Google Sheets...', icon: FileSpreadsheet, count: 5, color: 'text-info', bgColor: 'bg-blue-100' },
    { id: 'specialty', title: 'Spécialisés', description: 'Lightspeed, Ecwid, Squarespace...', icon: Settings, count: 4, color: 'text-success', bgColor: 'bg-green-100' },
  ...
  return (
    <ChannablePageWrapper
      title="Hub Import"
      description="Importez vos produits depuis multiples sources en quelques clics"
      heroImage="import"
