...
export function EnhancedProductsTable({
  ...
  const getSourceBadge = (source: string) => {
    const configs = {
      imported: { label: 'Importé', className: 'bg-info/10 text-blue-700 border-blue-200' },
      ...
      products: { label: 'Manuel', className: 'bg-success/10 text-success border-green-200' }
    }
                        ...
                        <Badge 
                          ...
                          className={cn(
                            ...
                            (product.profit_margin || 0) > 30 
                              ...
                              ? "bg-warning/10 text-yellow-700 border-yellow-200"
                              : "bg-destructive/10 text-red-700 border-red-200"
                          )}
                        >
