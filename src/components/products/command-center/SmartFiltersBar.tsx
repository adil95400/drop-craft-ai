...
const filterVariants: Record<SmartFilterType, string> = {
  ...
  at_risk: 'bg-destructive/10 text-destructive dark:text-red-400 hover:bg-destructive/20',
  profitable: 'bg-success/10 text-success dark:text-emerald-400 hover:bg-success/20',
  no_price_rule: 'bg-info/10 text-info dark:text-blue-400 hover:bg-info/20',
  not_synced: 'bg-warning/10 text-warning dark:text-orange-400 hover:bg-warning/20',
  ai_recommended: 'bg-purple-500/10 text-purple-600 dark:text-purple-400 hover:bg-purple-500/20',
  losing_margin: 'bg-warning/10 text-warning dark:text-amber-400 hover:bg-warning/20'
}
