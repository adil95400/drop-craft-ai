    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="p-4 rounded-lg border bg-info/5 dark:bg-blue-950/20">
        ...
        {/* Info banner */}
        <div className="p-4 bg-warning/5 dark:bg-yellow-950/20 rounded-lg flex items-start gap-3">
