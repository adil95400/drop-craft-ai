...
export const CreateIntegrationDialog = ({ open, onOpenChange }: CreateIntegrationDialogProps) => {
  ...
  const renderStep = () => {
    ...
    if (currentStep === 2) return (
      <div className="space-y-6">
        <div className="text-center pb-4">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-amber-500/10 flex items-center justify-center mb-3"><Key className="h-8 w-8 text-warning" /></div>
    ...
    return (
      <div className="space-y-6">
        <div className="text-center pb-4">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-green-500/10 flex items-center justify-center mb-3"><Zap className="h-8 w-8 text-success" /></div>
