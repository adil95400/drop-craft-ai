...
const METHOD_COLORS: Record<string, string> = {
  GET: 'bg-info/10 text-blue-700 dark:text-blue-400 border-info/30',
  POST: 'bg-success/10 text-success dark:text-green-400 border-success/30',
  ...
  DELETE: 'bg-destructive/10 text-red-700 dark:text-red-400 border-destructive/30',
};
  ...
  -H "x-api-key: sk_xxxxxxxx_xxxxxxxxxxxxxxxxxxxx"`}</pre>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div className="flex items-center gap-2"><Badge className="bg-success/10 text-success border-success/30" variant="outline">200</Badge> Succès</div>
                  <div className="flex items-center gap-2"><Badge className="bg-success/10 text-success border-success/30" variant="outline">201</Badge> Créé</div>
                  <div className="flex items-center gap-2"><Badge className="bg-destructive/10 text-red-700 border-destructive/30" variant="outline">401</Badge> Non autorisé</div>
                  <div className="flex items-center gap-2"><Badge className="bg-destructive/10 text-red-700 border-destructive/30" variant="outline">403</Badge> Interdit (scope manquant)</div>
                  <div className="flex items-center gap-2"><Badge className="bg-destructive/10 text-red-700 border-destructive/30" variant="outline">404</Badge> Non trouvé</div>
                  <div className="flex items-center gap-2"><Badge className="bg-destructive/10 text-red-700 border-destructive/30" variant="outline">429</Badge> Rate limit atteint</div>
                </div>
              </div>
            </CardContent>
          </Card>
