...
const priorityConfig = {
  ...
  medium: { label: 'Moyenne', color: 'bg-info/10 text-info' },
  high: { label: 'Haute', color: 'bg-warning/10 text-warning' },
            ...
            {isLoading ? (
              ...
              <AnimatePresence>
                {messages.map((msg, index) => (
                  ...
                  >
                    <Avatar className="h-8 w-8">
                      <AvatarFallback className={msg.is_staff ? 'bg-success/10 text-success' : 'bg-primary/10 text-primary'}>
