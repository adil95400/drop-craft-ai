...
export const QuickActions: React.FC = () => {
  ...
  const actions: QuickAction[] = [
    ...
    },
    {
      ...
      color: 'bg-gradient-to-r from-info to-purple-500 hover:from-blue-600 hover:to-purple-600',
      badge: 'Ultra Pro',
      planRequired: 'ultra_pro',
      priority: 'medium',
      category: 'premium'
    },
    {
      ...
      color: 'bg-gradient-to-r from-success to-blue-500 hover:from-green-600 hover:to-info',
      badge: 'Ultra Pro',
      planRequired: 'ultra_pro',
      priority: 'medium',
      category: 'premium'
