  ...
  suppliers: [
    {
      ...
      features: ['supplier-overview', 'stats'],
    ...
    },
    {
      ...
      route: '/suppliers/my',
      icon: 'Users',
      description: 'Gérer vos fournisseurs connectés',
      features: ['supplier-management', 'performance-tracking'],
      parentModule: 'suppliers',
      order: 3,
      minPlan: 'standard'
    },
    {
      id: 'suppliers-premium',
      name: 'Fournisseurs Premium',
      route: '/suppliers/premium',
      icon: 'Crown',
      description: 'Accéder aux fournisseurs premium',
      features: ['premium-suppliers', 'exclusive-products'],
      parentModule: 'suppliers',
      order: 4,
      minPlan: 'pro'
    },
    {
      ...
      icon: 'BarChart3',
      description: 'Performances et KPIs fournisseurs',
      features: ['supplier-analytics', 'performance-metrics'],
      parentModule: 'suppliers',
      order: 5,
      minPlan: 'standard'
    },
    {
      ...
      icon: 'Settings',
      description: 'Configuration des connecteurs',
      features: ['connector-config', 'sync-settings'],
      parentModule: 'suppliers',
      order: 6,
      minPlan: 'standard'
    }
