...
export const MODULE_REGISTRY: Record<string, ModuleConfig> = {
  ...
  import: {
    ...
    minPlan: 'standard',
    route: '/import',
    features: ['csv-import', 'url-import', 'api-import', 'field-mapping'],
    description: 'Importer des produits',
    category: 'product',
    order: 1,
    groupId: 'sources',
    subModules: [
      { id: 'import-advanced', name: 'Import Avancé', route: '/import', icon: 'Upload', description: 'Import complet avec mapping', features: ['csv', 'url', 'api', 'field-mapping'], order: 1 },
      { id: 'import-history', name: 'Historique', route: '/import/history', icon: 'History', description: 'Historique des imports', features: ['logs'], order: 2 },
      { id: 'import-config', name: 'Configuration', route: '/import/config', icon: 'Settings', description: 'Configuration des imports', features: ['config'], order: 3 },
    ]
  },
  ...
  stores: {
    ...
    features: ['store-management', 'multi-store', 'shopify'],
    ...
    subModules: [
      ...
      { id: 'stores-shopify', name: 'Shopify', route: '/stores-channels/shopify', icon: 'Store', description: 'Synchronisation Shopify', features: ['shopify'], order: 2 },
