...
export const ROUTES_REGISTRY: RouteConfig[] = [
  ...
  { path: '/stock/inventory-hub', protected: true, category: 'core', description: 'Hub Inventaire - Niveaux, entrepôts, alertes', implemented: true },
  { path: '/stock/warehouses', protected: true, category: 'core', description: 'Gestion des entrepôts', implemented: true },
  { path: '/stock/movements', protected: true, category: 'core', description: 'Mouvements de stock', implemented: true },
  { path: '/stock/alerts', protected: true, category: 'core', description: 'Alertes de stock', implemented: true },
